src/proto/ws-comms-rfc-5.gen.ts: node_modules/@dcl/protocol/kernel/comms/ws-comms-rfc-5.proto
	mkdir -p src/proto
...
src/proto/archipelago.gen.ts: node_modules/@dcl/protocol/kernel/comms/v3/archipelago.proto
	mkdir -p src/proto
	node_modules/.bin/protoc \
		--plugin=./node_modules/.bin/protoc-gen-ts_proto \
		--ts_proto_opt=esModuleInterop=true,returnObservable=false,outputServices=generic-definitions,oneof=unions \
